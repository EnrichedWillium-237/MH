...
void figRatiosNarrow() {
    ...
    h0->GetYaxis()->SetRangeUser(0.56, 1.44);
    ...
    for (int i = 0; i<ncbins; i++) {
        ...
        h0->Draw();
        ln0->Draw();
        rat_narrow_N1SUB2_eta[i]->SetMarkerStyle(20);
        rat_narrow_N1SUB2_eta[i]->SetMarkerSize(1.0);
        rat_narrow_N1SUB2_eta[i]->SetMarkerColor(kBlack);
        rat_narrow_N1SUB2_eta[i]->SetLineColor(kBlack);
        rat_narrow_N1SUB2_eta[i]->Draw("same");
    ...
    SetLegend(leg0, 18);
    leg0->AddEntry(rat_narrow_N1SUB2_eta[0], "narrow/nominal", "lp");
    leg0->Draw();
    c0->Print("figures/ratio_narrow_N1SUB_eta.pdf","pdf");
    ...
    h1->GetYaxis()->SetRangeUser(0.62, 1.38);
    ...
    for (int i = 0; i<ncbins; i++) {
        ...
        h1->Draw();
        ln1->Draw();
        rat_narrow_N1SUB2_pt[i]->SetMarkerStyle(20);
        rat_narrow_N1SUB2_pt[i]->SetMarkerSize(1.0);
        rat_narrow_N1SUB2_pt[i]->SetMarkerColor(kBlack);
        rat_narrow_N1SUB2_pt[i]->SetLineColor(kBlack);
        rat_narrow_N1SUB2_pt[i]->Draw("same");
    ...
    SetLegend(leg1, 18);
    leg1->AddEntry(rat_narrow_N1SUB2_eta[0], "narrow/nominal", "lp");
    leg1->Draw();
    c1->Print("figures/ratio_narrow_N1SUB_pt.pdf","pdf");
    ...
    for (int i = 0; i<ncbins; i++) {
        ...
        h2->Draw();
        ln2->Draw();
        rat_narrow_N1MCp22SUB2_pt[i]->SetMarkerStyle(20);
        rat_narrow_N1MCp22SUB2_pt[i]->SetMarkerSize(1.0);
        rat_narrow_N1MCp22SUB2_pt[i]->SetMarkerColor(kBlack);
        rat_narrow_N1MCp22SUB2_pt[i]->SetLineColor(kBlack);
        rat_narrow_N1MCp22SUB2_pt[i]->Draw("same");
    ...
    SetLegend(leg2, 18);
    leg2->AddEntry(rat_narrow_N1MCp22SUB2_pt[0], "narrow/nominal", "lp");
    leg2->Draw();
    c2->Print("figures/ratio_narrow_N1MCpSUB_pt.pdf","pdf");
