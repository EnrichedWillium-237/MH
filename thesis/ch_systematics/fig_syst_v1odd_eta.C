...
void fig_syst_v1odd_eta() {
    ...
    for (int cbin = 0; cbin<ncbins; cbin++) {
        ...
        N1HFgSUB3_tight[cbin] = (TGraphErrors *) fin->Get(Form("tight2/N1HFgSUB3/0.0_2.0/%d_%d/gint",cmin[cbin],cmax[cbin]));
        ...
        N1HFgSUB3_tight[cbin]->RemovePoint(0);
        N1HFgSUB3_tight[cbin]->RemovePoint(N1HFgSUB3_tight[cbin]->GetN()-1);

        N1HFgSUB3_loose[cbin] = (TGraphErrors *) fin->Get(Form("loose/N1HFgSUB3/0.0_2.0/%d_%d/gint",cmin[cbin],cmax[cbin]));
        ...
        N1HFgSUB3_loose[cbin]->RemovePoint(0);
        N1HFgSUB3_loose[cbin]->RemovePoint(N1HFgSUB3_loose[cbin]->GetN()-1);

        N1HFgSUB3_narrow[cbin] = (TGraphErrors *) fin->Get(Form("narrow/N1HFgSUB3/0.0_2.0/%d_%d/gint",cmin[cbin],cmax[cbin]));
        ...
        N1HFgSUB3_narrow[cbin]->RemovePoint(0);
        N1HFgSUB3_narrow[cbin]->RemovePoint(N1HFgSUB3_narrow[cbin]->GetN()-1);

        N1HFgSUB3_wide[cbin] = (TGraphErrors *) fin->Get(Form("wide/N1HFgSUB3/0.0_2.0/%d_%d/gint",cmin[cbin],cmax[cbin]));
        ...
        N1HFgSUB3_wide[cbin]->RemovePoint(0);
        N1HFgSUB3_wide[cbin]->RemovePoint(N1HFgSUB3_wide[cbin]->GetN()-1);
    ...
    h0->GetYaxis()->SetRangeUser(-0.014, 0.02);
    ...
    h1->GetYaxis()->SetRangeUser(-1.4, 1.4);
    h1->Draw();
    ...
    N1HFgSUB3_Diff_tight[setbin]->Fit(ftight, "0");
    TF1 * floose = new TF1("floose", "pol0", fitmin, fitmax);
    N1HFgSUB3_Diff_loose[setbin]->Fit(floose, "0");
    TPaveText * txt0_1 = new TPaveText(0.19, 0.28, 0.53, 0.48, "NDC");
    ...
    c0->Print("../figures/fig_syst_v1odd_trkCuts_eta.pdf","pdf");
    ...
    N1HFgSUB3_Diff_narrow[setbin]->Fit(fnarrow, "0");
    TF1 * fwide = new TF1("fwide", "pol0", fitmin, fitmax);
    N1HFgSUB3_Diff_wide[setbin]->Fit(fwide, "0");
    TPaveText * txt1_1 = new TPaveText(0.19, 0.28, 0.53, 0.48, "NDC");
    ...
    c1->Print("../figures/fig_syst_v1odd_vtxCuts_eta.pdf","pdf");
