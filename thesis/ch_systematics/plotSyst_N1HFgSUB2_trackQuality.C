...
void plotSyst_N1HFgSUB2_trackQuality() {
    ...
    h0_1->Draw();
    gint_N1HFgSUB2_tight[0]->Draw("same p");
    gint_N1HFgSUB2_loose[0]->Draw("same p");
    ...
    SetLegend(leg0, 24);
    leg0->AddEntry(gint_N1HFgSUB2_loose[0],"loose","p");
    leg0->AddEntry(gint_N1HFgSUB2_tight[0],"tight","p");
    leg0->AddEntry(gint_N1HFgSUB2[0],"nominal","p");
    leg0->Draw();
    c0->cd(2);
    TH1D * h0_2 = (TH1D *) h0_1->Clone("h0_2");
    h0_2->Draw();
    gint_N1HFgSUB2_tight[1]->Draw("same p");
    gint_N1HFgSUB2_loose[1]->Draw("same p");
    ...
    h0_3->Draw();
    gint_N1HFgSUB2_tight[2]->Draw("same p");
    gint_N1HFgSUB2_loose[2]->Draw("same p");
    ...
    h0_4->Draw();
    gint_N1HFgSUB2_tight[3]->Draw("same p");
    gint_N1HFgSUB2_loose[3]->Draw("same p");
    ...
    h0_5->Draw();
    diff_gint_N1HFgSUB2_tight[0]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[0]->Draw("same p");
    c0->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h0_6 = (TH1D *) h0_5->Clone("h0_6");
    h0_6->Draw();
    diff_gint_N1HFgSUB2_tight[1]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[1]->Draw("same p");
    c0->cd(7);
    gPad->SetGrid(1,1);
    TH1D * h0_7 = (TH1D *) h0_5->Clone("h0_7");
    h0_7->Draw();
    diff_gint_N1HFgSUB2_tight[2]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[2]->Draw("same p");
    TPad * pad0_8 = (TPad *) c0->cd(8);
    pad0_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);
    TH1D * h0_8 = (TH1D *) h0_5->Clone("h0_8");
    h0_8->Draw();
    diff_gint_N1HFgSUB2_tight[3]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[3]->Draw("same p");
    ...
    h1_1->Draw();
    gint_N1HFgSUB2_tight[4]->Draw("same p");
    gint_N1HFgSUB2_loose[4]->Draw("same p");
    ...
    SetLegend(leg1, 24);
    leg1->AddEntry(gint_N1HFgSUB2_loose[4],"loose","p");
    leg1->AddEntry(gint_N1HFgSUB2_tight[4],"tight","p");
    leg1->AddEntry(gint_N1HFgSUB2[4],"nominal","p");
    leg1->Draw();
    c1->cd(2);
    TH1D * h1_2 = (TH1D *) h1_1->Clone("h1_2");
    h1_2->Draw();
    gint_N1HFgSUB2_tight[5]->Draw("same p");
    gint_N1HFgSUB2_loose[5]->Draw("same p");
    ...
    h1_3->Draw();
    gint_N1HFgSUB2_tight[6]->Draw("same p");
    gint_N1HFgSUB2_loose[6]->Draw("same p");
    ...
    h1_4->Draw();
    gint_N1HFgSUB2_tight[7]->Draw("same p");
    gint_N1HFgSUB2_loose[7]->Draw("same p");
    ...
    h1_5->Draw();
    diff_gint_N1HFgSUB2_tight[4]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[4]->Draw("same p");
    c1->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h1_6 = (TH1D *) h1_5->Clone("h1_6");
    h1_6->Draw();
    diff_gint_N1HFgSUB2_tight[5]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[5]->Draw("same p");
    c1->cd(7);
    gPad->SetGrid(1,1);
    TH1D * h1_7 = (TH1D *) h1_5->Clone("h1_7");
    h1_7->Draw();
    diff_gint_N1HFgSUB2_tight[6]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[6]->Draw("same p");
    TPad * pad1_8 = (TPad *) c1->cd(8);
    pad1_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);
    TH1D * h1_8 = (TH1D *) h1_5->Clone("h1_8");
    h1_8->Draw();
    diff_gint_N1HFgSUB2_tight[7]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[7]->Draw("same p");
    ...
    h2_1->Draw();
    gint_N1HFgSUB2_tight[8]->Draw("same p");
    gint_N1HFgSUB2_loose[8]->Draw("same p");
    ...
    SetLegend(leg1a, 24);
    leg1a->AddEntry(gint_N1HFgSUB2_loose[8],"loose","p");
    leg1a->AddEntry(gint_N1HFgSUB2_tight[8],"tight","p");
    leg1a->AddEntry(gint_N1HFgSUB2[8],"nominal","p");
    leg1a->Draw();
    c2->cd(2);
    TH1D * h2_2 = (TH1D *) h2_1->Clone("h2_2");
    h2_2->Draw();
    gint_N1HFgSUB2_tight[9]->Draw("same p");
    gint_N1HFgSUB2_loose[9]->Draw("same p");
    ...
    h2_3->Draw();
    gint_N1HFgSUB2_tight[10]->Draw("same p");
    gint_N1HFgSUB2_loose[10]->Draw("same p");
    ...
    h2_5->Draw();
    diff_gint_N1HFgSUB2_tight[8]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[8]->Draw("same p");
    c2->cd(5);
    gPad->SetGrid(1,1);
    TH1D * h2_6 = (TH1D *) h2_5->Clone("h2_6");
    h2_6->Draw();
    diff_gint_N1HFgSUB2_tight[9]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[9]->Draw("same p");
    c2->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h2_7 = (TH1D *) h2_5->Clone("h2_7");
    h2_7->Draw();
    diff_gint_N1HFgSUB2_tight[10]->Draw("same p");
    diff_gint_N1HFgSUB2_loose[10]->Draw("same p");
