...
void fig_syst_v1even_eta_trckqual() {
    ...
    c0->Print("../fig_syst_v1even_eta_trackQuality_0_20.pdf","pdf");
    ...
    c1->Print("../fig_syst_v1even_eta_trackQuality_20_40.pdf","pdf");
    ...
    c2->Print("../fig_syst_v1even_eta_trackQuality_40_70.pdf","pdf");
