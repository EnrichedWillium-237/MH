...
TGraphErrors * gA_N1EVENSUB3[ncbins];
TGraphErrors * gA_N1EVENSUB3_narrow[ncbins];
TGraphErrors * gA_N1EVENSUB3_wide[ncbins];

TGraphErrors * ratio_gA_N1EVENSUB3_narrow[ncbins];
TGraphErrors * ratio_gA_N1EVENSUB3_wide[ncbins];

TGraphErrors * diff_gA_N1EVENSUB3_narrow[ncbins];
TGraphErrors * diff_gA_N1EVENSUB3_wide[ncbins];

TGraphErrors * g_N1EVENSUB3[ncbins];
TGraphErrors * g_N1EVENSUB3_narrow[ncbins];
TGraphErrors * g_N1EVENSUB3_wide[ncbins];

TGraphErrors * ratio_g_N1EVENSUB3_narrow[ncbins];
TGraphErrors * ratio_g_N1EVENSUB3_wide[ncbins];

TGraphErrors * diff_g_N1EVENSUB3_narrow[ncbins];
TGraphErrors * diff_g_N1EVENSUB3_wide[ncbins];

TCanvas * cN1EVENSUB3_gA_trackQuality[ncbins];
TCanvas * cN1EVENSUB3_gA_vtxRange[ncbins];
...
void fig_syst_decor_v1even_pt_vtxcut() {
    ...
    for (int cbin = 0; cbin<ncbins; cbin++) {
        ...
        // cN1EVENSUB3_gA_vtxRange[cbin] = (TCanvas *) fin->Get(Form("%s/syserr_N1EVENSUB3_gA_0.4_2.4_%d_%d_vtxRange",tag.data(),cmin[cbin],cmax[cbin]));

        gA_N1EVENSUB3[cbin] = (TGraphErrors *) fin->Get(Form("%s/gA",tag.data()));
        gA_N1EVENSUB3_narrow[cbin] = (TGraphErrors *) fin->Get(Form("narrow/N1EVENSUB3_decor/0.4_2.4/%d_%d/gA",cmin[cbin],cmax[cbin]));
        gA_N1EVENSUB3_wide[cbin] = (TGraphErrors *) fin->Get(Form("wide/N1EVENSUB3_decor/0.4_2.4/%d_%d/gA",cmin[cbin],cmax[cbin]));

        ratio_gA_N1EVENSUB3_narrow[cbin] = (TGraphErrors *) fin->Get(Form("%s/Ratio_narrow_N1EVENSUB3_decor_0.4_2.4_%d_%d_gA",tag.data(),cmin[cbin],cmax[cbin]));
        ratio_gA_N1EVENSUB3_wide[cbin] = (TGraphErrors *) fin->Get(Form("%s/Ratio_wide_N1EVENSUB3_decor_0.4_2.4_%d_%d_gA",tag.data(),cmin[cbin],cmax[cbin]));

        diff_gA_N1EVENSUB3_narrow[cbin] = (TGraphErrors *) fin->Get(Form("%s/Difference_narrow_N1EVENSUB3_decor_0.4_2.4_%d_%d_gA",tag.data(),cmin[cbin],cmax[cbin]));
        diff_gA_N1EVENSUB3_wide[cbin] = (TGraphErrors *) fin->Get(Form("%s/Difference_wide_N1EVENSUB3_decor_0.4_2.4_%d_%d_gA",tag.data(),cmin[cbin],cmax[cbin]));

        gA_N1EVENSUB3[cbin]->SetMarkerStyle(25);
        gA_N1EVENSUB3[cbin]->SetMarkerSize(1.0);
        gA_N1EVENSUB3[cbin]->SetMarkerColor(kRed);
        gA_N1EVENSUB3[cbin]->SetLineColor(kRed);

        gA_N1EVENSUB3_wide[cbin]->SetMarkerStyle(20);
        gA_N1EVENSUB3_wide[cbin]->SetMarkerSize(1.0);
        gA_N1EVENSUB3_wide[cbin]->SetMarkerColor(kBlue);
        gA_N1EVENSUB3_wide[cbin]->SetLineColor(kBlue);

        gA_N1EVENSUB3_narrow[cbin]->SetMarkerStyle(20);
        gA_N1EVENSUB3_narrow[cbin]->SetMarkerSize(1.0);
        gA_N1EVENSUB3_narrow[cbin]->SetMarkerColor(kGreen+2);
        gA_N1EVENSUB3_narrow[cbin]->SetLineColor(kGreen+2);

        ratio_gA_N1EVENSUB3_narrow[cbin]->SetMarkerStyle(20);
        ratio_gA_N1EVENSUB3_narrow[cbin]->SetMarkerSize(1.0);
        ratio_gA_N1EVENSUB3_narrow[cbin]->SetMarkerColor(kGreen+2);
        ratio_gA_N1EVENSUB3_narrow[cbin]->SetLineColor(kGreen+2);

        ratio_gA_N1EVENSUB3_wide[cbin]->SetMarkerStyle(20);
        ratio_gA_N1EVENSUB3_wide[cbin]->SetMarkerSize(1.0);
        ratio_gA_N1EVENSUB3_wide[cbin]->SetMarkerColor(kBlue);
        ratio_gA_N1EVENSUB3_wide[cbin]->SetLineColor(kBlue);


        diff_gA_N1EVENSUB3_narrow[cbin]->SetMarkerStyle(20);
        diff_gA_N1EVENSUB3_narrow[cbin]->SetMarkerSize(1.0);
        diff_gA_N1EVENSUB3_narrow[cbin]->SetMarkerColor(kGreen+2);
        diff_gA_N1EVENSUB3_narrow[cbin]->SetLineColor(kGreen+2);

        diff_gA_N1EVENSUB3_wide[cbin]->SetMarkerStyle(20);
        diff_gA_N1EVENSUB3_wide[cbin]->SetMarkerSize(1.0);
        diff_gA_N1EVENSUB3_wide[cbin]->SetMarkerColor(kBlue);
        diff_gA_N1EVENSUB3_wide[cbin]->SetLineColor(kBlue);


        string mtag = Form("N1EVENSUB3_%d_%d",cmin[cbin],cmax[cbin]);


        cN1EVENSUB3_gA_vtxRange[cbin] = new TCanvas(Form("c%s_vtxRange",mtag.data()), Form("c%s_vtxRange",mtag.data()), 600, 900);
        cN1EVENSUB3_gA_vtxRange[cbin]->Divide(1,3,0,0);
        TPad * pad1 = (TPad *) cN1EVENSUB3_gA_vtxRange[cbin]->cd(1);
        ...
        h1->Draw();
        gA_N1EVENSUB3_wide[cbin]->Draw("same p");
        gA_N1EVENSUB3_narrow[cbin]->Draw("same p");
        gA_N1EVENSUB3[cbin]->Draw("same p");
        ...
        SetLegend(leg, 24);
        leg->AddEntry(gA_N1EVENSUB3_wide[cbin],"wide","p");
        leg->AddEntry(gA_N1EVENSUB3_narrow[cbin],"narrow","p");
        leg->AddEntry(gA_N1EVENSUB3[cbin],"nominal","p");
        leg->Draw();

        TPad * pad2 = (TPad *) cN1EVENSUB3_gA_vtxRange[cbin]->cd(2);
        ...
        lnrat->Draw();
        ratio_gA_N1EVENSUB3_wide[cbin]->Draw("same p");
        ratio_gA_N1EVENSUB3_narrow[cbin]->Draw("same p");
        TF1 * fit_rat_wide = new TF1("fir_rat_wide", "pol0", -2, 2);
        TGraphErrors * tmp_rat_wide1 = (TGraphErrors *) ratio_gA_N1EVENSUB3_wide[cbin]->Clone();
        ...
        TGraphErrors * tmp_rat_narrow = (TGraphErrors *) ratio_gA_N1EVENSUB3_narrow[cbin]->Clone();
        ...
        TPad * pad3 = (TPad *) cN1EVENSUB3_gA_vtxRange[cbin]->cd(3);
        ...
        lndiff->Draw();
        diff_gA_N1EVENSUB3_wide[cbin]->Draw("same p");
        diff_gA_N1EVENSUB3_narrow[cbin]->Draw("same p");
        TF1 * fit_diff_wide = new TF1("fir_diff_wide", "pol1", -2, 2);
        TGraphErrors * tmp_diff_wide = (TGraphErrors *) diff_gA_N1EVENSUB3_wide[cbin]->Clone();
        cout<<"\ncrange: "<<cmin[cbin]<<"\t"<<cmax[cbin]<<endl;
        cout<<"wide difference: "<<endl;
        tmp_diff_wide->Fit(fit_diff_wide);
        TF1 * fit_diff_narrow = new TF1("fir_diff_narrow", "pol1", -2, 2);
        TGraphErrors * tmp_diff_narrow = (TGraphErrors *) diff_gA_N1EVENSUB3_narrow[cbin]->Clone();
        ...
        cN1EVENSUB3_gA_vtxRange[cbin]->Print(Form("plots/N1EVENSUB3_decor/cN1EVENSUB3_decor_gA_vtxRange_%d_%d.pdf",cmin[cbin],cmax[cbin]),"pdf");
        cN1EVENSUB3_gA_vtxRange[cbin]->Close();


        cN1EVENSUB3_gA_vtxRange[cbin] = new TCanvas(Form("c%s_vtxRange",mtag.data()), Form("c%s_vtxRange",mtag.data()), 600, 900);
        cN1EVENSUB3_gA_vtxRange[cbin]->Divide(1,3,0,0);
        TPad * pad1a = (TPad *) cN1EVENSUB3_gA_vtxRange[cbin]->cd(1);
        ...
        SetLegend(lega, 24);
        lega->AddEntry(gA_N1EVENSUB3_wide[cbin],"wide","p");
        lega->AddEntry(gA_N1EVENSUB3_narrow[cbin],"narrow","p");
        lega->AddEntry(gA_N1EVENSUB3[cbin],"nominal","p");
        lega->Draw();

        TPad * pad2a = (TPad *) cN1EVENSUB3_gA_vtxRange[cbin]->cd(2);
        ...
        TGraphErrors * tmp_rat_wide = (TGraphErrors *) ratio_gA_N1EVENSUB3_wide[cbin]->Clone();
        cout<<"\ncrange: "<<cmin[cbin]<<"\t"<<cmax[cbin]<<endl;
        cout<<"wide ratio: "<<endl;
        tmp_rat_wide->Fit(fit_rat_wide1);
        TF1 * fit_rat_narrow1 = new TF1("fir_rat_narrow", "pol0", -2, 2);
        TGraphErrors * tmp_rat_narrow1 = (TGraphErrors *) ratio_gA_N1EVENSUB3_narrow[cbin]->Clone();
        cout<<"narrow ratio: "<<endl;
        tmp_rat_narrow1->Fit(fit_rat_narrow1);
        fitwide_rat_p0[cbin] = fit_rat_wide1->GetParameter(0);
        fitnarrow_rat_p0[cbin] = fit_rat_narrow->GetParameter(0);

        TPad * pad3a = (TPad *) cN1EVENSUB3_gA_vtxRange[cbin]->cd(3);
        ...
        TGraphErrors * tmp_diff_wide1 = (TGraphErrors *) diff_gA_N1EVENSUB3_wide[cbin]->Clone();
        cout<<"\ncrange: "<<cmin[cbin]<<"\t"<<cmax[cbin]<<endl;
        cout<<"wide difference: "<<endl;
        tmp_diff_wide1->Fit(fit_diff_wide1);
        TF1 * fit_diff_narrow1 = new TF1("fir_diff_narrow", "pol1", -2, 2);
        TGraphErrors * tmp_diff_narrow1 = (TGraphErrors *) diff_gA_N1EVENSUB3_narrow[cbin]->Clone();
        cout<<"narrow difference: "<<endl;
    ...
    h0_1->Draw();
    gA_N1EVENSUB3_wide[0]->Draw("same p");
    gA_N1EVENSUB3_narrow[0]->Draw("same p");
    gA_N1EVENSUB3[0]->Draw("same p");
    ...
    SetLegend(leg0, 24);
    leg0->AddEntry(gA_N1EVENSUB3_wide[0],"wide","p");
    leg0->AddEntry(gA_N1EVENSUB3_narrow[0],"narrow","p");
    leg0->AddEntry(gA_N1EVENSUB3[0],"nominal","p");
    leg0->Draw();
    c0->cd(2);
    TH1D * h0_2 = (TH1D *) h0_1->Clone("h0_2");
    h0_2->Draw();
    gA_N1EVENSUB3_wide[1]->Draw("same p");
    gA_N1EVENSUB3_narrow[1]->Draw("same p");
    gA_N1EVENSUB3[1]->Draw("same p");
    ...
    h0_3->Draw();
    gA_N1EVENSUB3_wide[2]->Draw("same p");
    gA_N1EVENSUB3_narrow[2]->Draw("same p");
    gA_N1EVENSUB3[2]->Draw("same p");
    ...
    h0_4->Draw();
    gA_N1EVENSUB3_wide[3]->Draw("same p");
    gA_N1EVENSUB3_narrow[3]->Draw("same p");
    gA_N1EVENSUB3[3]->Draw("same p");
    ...
    h0_5->Draw();
    diff_gA_N1EVENSUB3_wide[0]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[0]->Draw("same p");
    c0->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h0_6 = (TH1D *) h0_5->Clone("h0_6");
    h0_6->Draw();
    diff_gA_N1EVENSUB3_wide[1]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[1]->Draw("same p");
    c0->cd(7);
    gPad->SetGrid(1,1);
    TH1D * h0_7 = (TH1D *) h0_5->Clone("h0_7");
    h0_7->Draw();
    diff_gA_N1EVENSUB3_wide[2]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[2]->Draw("same p");
    TPad * pad0_8 = (TPad *) c0->cd(8);
    pad0_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);
    TH1D * h0_8 = (TH1D *) h0_5->Clone("h0_8");
    h0_8->Draw();
    diff_gA_N1EVENSUB3_wide[3]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[3]->Draw("same p");

    c0->Print("../fig_syst_decor_v1even_pt_vtxcut_0_20.pdf","pdf");
    ...
    h1_1->Draw();
    gA_N1EVENSUB3_wide[4]->Draw("same p");
    gA_N1EVENSUB3_narrow[4]->Draw("same p");
    gA_N1EVENSUB3[4]->Draw("same p");
    ...
    SetLegend(leg1, 24);
    leg1->AddEntry(gA_N1EVENSUB3_wide[4],"wide","p");
    leg1->AddEntry(gA_N1EVENSUB3_narrow[4],"narrow","p");
    leg1->AddEntry(gA_N1EVENSUB3[4],"nominal","p");
    leg1->Draw();
    c1->cd(2);
    TH1D * h1_2 = (TH1D *) h1_1->Clone("h1_2");
    h1_2->Draw();
    gA_N1EVENSUB3_wide[5]->Draw("same p");
    gA_N1EVENSUB3_narrow[5]->Draw("same p");
    gA_N1EVENSUB3[5]->Draw("same p");
    ...
    h1_3->Draw();
    gA_N1EVENSUB3_wide[6]->Draw("same p");
    gA_N1EVENSUB3_narrow[6]->Draw("same p");
    gA_N1EVENSUB3[6]->Draw("same p");
    ...
    h1_4->Draw();
    gA_N1EVENSUB3_wide[7]->Draw("same p");
    gA_N1EVENSUB3_narrow[7]->Draw("same p");
    gA_N1EVENSUB3[7]->Draw("same p");
    ...
    h1_5->Draw();
    diff_gA_N1EVENSUB3_wide[4]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[4]->Draw("same p");
    c1->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h1_6 = (TH1D *) h1_5->Clone("h1_6");
    h1_6->Draw();
    diff_gA_N1EVENSUB3_wide[5]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[5]->Draw("same p");
    c1->cd(7);
    gPad->SetGrid(1,1);
    TH1D * h1_7 = (TH1D *) h1_5->Clone("h1_7");
    h1_7->Draw();
    diff_gA_N1EVENSUB3_wide[6]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[6]->Draw("same p");
    TPad * pad1_8 = (TPad *) c1->cd(8);
    pad1_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);
    TH1D * h1_8 = (TH1D *) h1_5->Clone("h1_8");
    h1_8->Draw();
    diff_gA_N1EVENSUB3_wide[7]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[7]->Draw("same p");

    c1->Print("../fig_syst_decor_v1even_pt_vtxcut_20_40.pdf","pdf");
    ...
    h2_1->Draw();
    gA_N1EVENSUB3_wide[8]->Draw("same p");
    gA_N1EVENSUB3_narrow[8]->Draw("same p");
    gA_N1EVENSUB3[8]->Draw("same p");
    ...
    SetLegend(leg1_1, 24);
    leg1_1->AddEntry(gA_N1EVENSUB3_wide[8],"wide","p");
    leg1_1->AddEntry(gA_N1EVENSUB3_narrow[8],"narrow","p");
    leg1_1->AddEntry(gA_N1EVENSUB3[8],"nominal","p");
    leg1_1->Draw();
    c2->cd(2);
    TH1D * h2_2 = (TH1D *) h2_1->Clone("h2_2");
    h2_2->Draw();
    gA_N1EVENSUB3_wide[9]->Draw("same p");
    gA_N1EVENSUB3_narrow[9]->Draw("same p");
    gA_N1EVENSUB3[9]->Draw("same p");
    ...
    h2_3->Draw();
    gA_N1EVENSUB3_wide[10]->Draw("same p");
    gA_N1EVENSUB3_narrow[10]->Draw("same p");
    gA_N1EVENSUB3[10]->Draw("same p");
    ...
    h2_5->Draw();
    diff_gA_N1EVENSUB3_wide[8]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[8]->Draw("same p");
    c2->cd(5);
    gPad->SetGrid(1,1);
    TH1D * h2_6 = (TH1D *) h2_5->Clone("h2_6");
    h2_6->Draw();
    diff_gA_N1EVENSUB3_wide[9]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[9]->Draw("same p");
    c2->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h2_7 = (TH1D *) h2_5->Clone("h2_7");
    h2_7->Draw();
    diff_gA_N1EVENSUB3_wide[10]->Draw("same p");
    diff_gA_N1EVENSUB3_narrow[10]->Draw("same p");
    TPad * pad2_8 = (TPad *) c2->cd(7);
    pad2_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);

    c2->Print("../fig_syst_decor_v1even_pt_vtxcut_40_70.pdf","pdf");
