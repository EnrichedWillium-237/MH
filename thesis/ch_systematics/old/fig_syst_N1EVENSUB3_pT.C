...
void fig_syst_N1EVENSUB3_pT() {
    ...
    c0->Print("../figures/fig_syst_N1EVENSUB3_trkCuts_pT.pdf","pdf");
    ...
    c1->Print("../figures/fig_syst_N1EVENSUB3_vtxCuts_pT.pdf","pdf");
