...
TGraphErrors * gint_N1EVENSUB3_loose[ncbins];

TGraphErrors * ratio_gint_N1EVENSUB3_tight[ncbins];
TGraphErrors * ratio_gint_N1EVENSUB3_loose[ncbins];

TGraphErrors * diff_gint_N1EVENSUB3_tight[ncbins];
TGraphErrors * diff_gint_N1EVENSUB3_loose[ncbins];
...
TCanvas * cN1EVENSUB3_gint_trackQuality[ncbins];
TCanvas * cN1EVENSUB3_gint_vtxRange[ncbins];
...
void fig_syst_decor_v1even_eta_trckqual() {
    ...
    for (int cbin = 0; cbin<ncbins; cbin++) {
        ...
        ratio_gint_N1EVENSUB3_loose[cbin] = (TGraphErrors *) fin->Get(Form("%s/Ratio_loose_N1EVENSUB3_decor_0.4_2.4_%d_%d_gint",tag.data(),cmin[cbin],cmax[cbin]));

        diff_gint_N1EVENSUB3_tight[cbin] = (TGraphErrors *) fin->Get(Form("%s/Difference_tight2_N1EVENSUB3_decor_0.4_2.4_%d_%d_gint",tag.data(),cmin[cbin],cmax[cbin]));
        diff_gint_N1EVENSUB3_loose[cbin] = (TGraphErrors *) fin->Get(Form("%s/Difference_loose_N1EVENSUB3_decor_0.4_2.4_%d_%d_gint",tag.data(),cmin[cbin],cmax[cbin]));

        gint_N1EVENSUB3[cbin]->SetMarkerStyle(25);
        gint_N1EVENSUB3[cbin]->SetMarkerSize(1.0);
        gint_N1EVENSUB3[cbin]->SetMarkerColor(kRed);
        gint_N1EVENSUB3[cbin]->SetLineColor(kRed);
        gint_N1EVENSUB3[cbin]->RemovePoint(5);
        gint_N1EVENSUB3[cbin]->RemovePoint(5);

        gint_N1EVENSUB3_loose[cbin]->SetMarkerStyle(20);
        gint_N1EVENSUB3_loose[cbin]->SetMarkerSize(1.0);
        gint_N1EVENSUB3_loose[cbin]->SetMarkerColor(kBlue);
        gint_N1EVENSUB3_loose[cbin]->SetLineColor(kBlue);
        gint_N1EVENSUB3_loose[cbin]->RemovePoint(5);
        gint_N1EVENSUB3_loose[cbin]->RemovePoint(5);

        gint_N1EVENSUB3_tight[cbin]->SetMarkerStyle(20);
        gint_N1EVENSUB3_tight[cbin]->SetMarkerSize(1.0);
        gint_N1EVENSUB3_tight[cbin]->SetMarkerColor(kGreen+2);
        gint_N1EVENSUB3_tight[cbin]->SetLineColor(kGreen+2);
        gint_N1EVENSUB3_tight[cbin]->RemovePoint(5);
        gint_N1EVENSUB3_tight[cbin]->RemovePoint(5);

        ratio_gint_N1EVENSUB3_tight[cbin]->SetMarkerStyle(20);
        ratio_gint_N1EVENSUB3_tight[cbin]->SetMarkerSize(1.0);
        ratio_gint_N1EVENSUB3_tight[cbin]->SetMarkerColor(kGreen+2);
        ratio_gint_N1EVENSUB3_tight[cbin]->SetLineColor(kGreen+2);
        ratio_gint_N1EVENSUB3_tight[cbin]->RemovePoint(5);
        ratio_gint_N1EVENSUB3_tight[cbin]->RemovePoint(5);

        ratio_gint_N1EVENSUB3_loose[cbin]->SetMarkerStyle(20);
        ratio_gint_N1EVENSUB3_loose[cbin]->SetMarkerSize(1.0);
        ratio_gint_N1EVENSUB3_loose[cbin]->SetMarkerColor(kBlue);
        ratio_gint_N1EVENSUB3_loose[cbin]->SetLineColor(kBlue);
        ratio_gint_N1EVENSUB3_loose[cbin]->RemovePoint(5);
        ratio_gint_N1EVENSUB3_loose[cbin]->RemovePoint(5);


        diff_gint_N1EVENSUB3_tight[cbin]->SetMarkerStyle(20);
        diff_gint_N1EVENSUB3_tight[cbin]->SetMarkerSize(1.0);
        diff_gint_N1EVENSUB3_tight[cbin]->SetMarkerColor(kGreen+2);
        diff_gint_N1EVENSUB3_tight[cbin]->SetLineColor(kGreen+2);
        diff_gint_N1EVENSUB3_tight[cbin]->RemovePoint(5);
        diff_gint_N1EVENSUB3_tight[cbin]->RemovePoint(5);

        diff_gint_N1EVENSUB3_loose[cbin]->SetMarkerStyle(20);
        diff_gint_N1EVENSUB3_loose[cbin]->SetMarkerSize(1.0);
        diff_gint_N1EVENSUB3_loose[cbin]->SetMarkerColor(kBlue);
        diff_gint_N1EVENSUB3_loose[cbin]->SetLineColor(kBlue);
        diff_gint_N1EVENSUB3_loose[cbin]->RemovePoint(5);
        diff_gint_N1EVENSUB3_loose[cbin]->RemovePoint(5);
        ...
        cN1EVENSUB3_gint_trackQuality[cbin] = new TCanvas(Form("c%s_trackQuality",mtag.data()), Form("c%s_trackQuality",mtag.data()), 600, 900);
        cN1EVENSUB3_gint_trackQuality[cbin]->Divide(1,3,0,0);
        TPad * pad1 = (TPad *) cN1EVENSUB3_gint_trackQuality[cbin]->cd(1);
        ...
        h1->Draw();
        gint_N1EVENSUB3_loose[cbin]->Draw("same p");
        gint_N1EVENSUB3_tight[cbin]->Draw("same p");
        gint_N1EVENSUB3[cbin]->Draw("same p");
        ...
        SetLegend(leg, 24);
        leg->AddEntry(gint_N1EVENSUB3_loose[cbin],"loose","p");
        leg->AddEntry(gint_N1EVENSUB3_tight[cbin],"tight","p");
        leg->AddEntry(gint_N1EVENSUB3[cbin],"nominal","p");
        leg->Draw();

        TPad * pad2 = (TPad *) cN1EVENSUB3_gint_trackQuality[cbin]->cd(2);
        ...
        lnrat->Draw();
        ratio_gint_N1EVENSUB3_loose[cbin]->Draw("same p");
        ratio_gint_N1EVENSUB3_tight[cbin]->Draw("same p");
        TF1 * fit_rat_loose = new TF1("fir_rat_loose", "pol0", -2, 2);
        TGraphErrors * tmp_rat_loose = (TGraphErrors *) ratio_gint_N1EVENSUB3_loose[cbin]->Clone();
        ...
        TGraphErrors * tmp_rat_tight = (TGraphErrors *) ratio_gint_N1EVENSUB3_tight[cbin]->Clone();
        ...
        TPad * pad3 = (TPad *) cN1EVENSUB3_gint_trackQuality[cbin]->cd(3);
        ...
        lndiff->Draw();
        diff_gint_N1EVENSUB3_loose[cbin]->Draw("same p");
        diff_gint_N1EVENSUB3_tight[cbin]->Draw("same p");
        TF1 * fit_diff_loose = new TF1("fir_diff_loose", "pol1", -2, 2);
        TGraphErrors * tmp_diff_loose = (TGraphErrors *) diff_gint_N1EVENSUB3_loose[cbin]->Clone();
        cout<<"\ncrange: "<<cmin[cbin]<<"\t"<<cmax[cbin]<<endl;
        cout<<"loose difference: "<<endl;
        tmp_diff_loose->Fit(fit_diff_loose);
        TF1 * fit_diff_tight = new TF1("fir_diff_tight", "pol1", -2, 2);
        TGraphErrors * tmp_diff_tight = (TGraphErrors *) diff_gint_N1EVENSUB3_tight[cbin]->Clone();
    ...
    h0_1->Draw();
    gint_N1EVENSUB3_loose[0]->Draw("same p");
    gint_N1EVENSUB3_tight[0]->Draw("same p");
    gint_N1EVENSUB3[0]->Draw("same p");
    ...
    SetLegend(leg0, 24);
    leg0->AddEntry(gint_N1EVENSUB3_loose[0],"loose","p");
    leg0->AddEntry(gint_N1EVENSUB3_tight[0],"tight","p");
    leg0->AddEntry(gint_N1EVENSUB3[0],"nominal","p");
    leg0->Draw();
    c0->cd(2);
    TH1D * h0_2 = (TH1D *) h0_1->Clone("h0_2");
    h0_2->Draw();
    gint_N1EVENSUB3_loose[1]->Draw("same p");
    gint_N1EVENSUB3_tight[1]->Draw("same p");
    gint_N1EVENSUB3[1]->Draw("same p");
    ...
    h0_3->Draw();
    gint_N1EVENSUB3_loose[2]->Draw("same p");
    gint_N1EVENSUB3_tight[2]->Draw("same p");
    gint_N1EVENSUB3[2]->Draw("same p");
    ...
    h0_4->Draw();
    gint_N1EVENSUB3_loose[3]->Draw("same p");
    gint_N1EVENSUB3_tight[3]->Draw("same p");
    gint_N1EVENSUB3[3]->Draw("same p");
    ...
    h0_5->Draw();
    diff_gint_N1EVENSUB3_loose[0]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[0]->Draw("same p");
    c0->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h0_6 = (TH1D *) h0_5->Clone("h0_6");
    h0_6->Draw();
    diff_gint_N1EVENSUB3_loose[1]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[1]->Draw("same p");
    c0->cd(7);
    gPad->SetGrid(1,1);
    TH1D * h0_7 = (TH1D *) h0_5->Clone("h0_7");
    h0_7->Draw();
    diff_gint_N1EVENSUB3_loose[2]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[2]->Draw("same p");
    TPad * pad0_8 = (TPad *) c0->cd(8);
    pad0_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);
    TH1D * h0_8 = (TH1D *) h0_5->Clone("h0_8");
    h0_8->Draw();
    diff_gint_N1EVENSUB3_loose[3]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[3]->Draw("same p");

    c0->Print("../fig_syst_decor_v1even_eta_trackQuality_0_20.pdf","pdf");
    ...
    h1_1->Draw();
    gint_N1EVENSUB3_loose[4]->Draw("same p");
    gint_N1EVENSUB3_tight[4]->Draw("same p");
    gint_N1EVENSUB3[4]->Draw("same p");
    ...
    SetLegend(leg1, 24);
    leg1->AddEntry(gint_N1EVENSUB3_loose[4],"loose","p");
    leg1->AddEntry(gint_N1EVENSUB3_tight[4],"tight","p");
    leg1->AddEntry(gint_N1EVENSUB3[4],"nominal","p");
    leg1->Draw();
    c1->cd(2);
    TH1D * h1_2 = (TH1D *) h1_1->Clone("h1_2");
    h1_2->Draw();
    gint_N1EVENSUB3_loose[5]->Draw("same p");
    gint_N1EVENSUB3_tight[5]->Draw("same p");
    gint_N1EVENSUB3[5]->Draw("same p");
    ...
    h1_3->Draw();
    gint_N1EVENSUB3_loose[6]->Draw("same p");
    gint_N1EVENSUB3_tight[6]->Draw("same p");
    gint_N1EVENSUB3[6]->Draw("same p");
    ...
    h1_4->Draw();
    gint_N1EVENSUB3_loose[7]->Draw("same p");
    gint_N1EVENSUB3_tight[7]->Draw("same p");
    gint_N1EVENSUB3[7]->Draw("same p");
    ...
    h1_5->Draw();
    diff_gint_N1EVENSUB3_loose[4]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[4]->Draw("same p");
    c1->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h1_6 = (TH1D *) h1_5->Clone("h1_6");
    h1_6->Draw();
    diff_gint_N1EVENSUB3_loose[5]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[5]->Draw("same p");
    c1->cd(7);
    gPad->SetGrid(1,1);
    TH1D * h1_7 = (TH1D *) h1_5->Clone("h1_7");
    h1_7->Draw();
    diff_gint_N1EVENSUB3_loose[6]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[6]->Draw("same p");
    TPad * pad1_8 = (TPad *) c1->cd(8);
    pad1_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);
    TH1D * h1_8 = (TH1D *) h1_5->Clone("h1_8");
    h1_8->Draw();
    diff_gint_N1EVENSUB3_loose[7]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[7]->Draw("same p");

    c1->Print("../fig_syst_decor_v1even_eta_trackQuality_20_40.pdf","pdf");
    ...
    h2_1->Draw();
    gint_N1EVENSUB3_loose[8]->Draw("same p");
    gint_N1EVENSUB3_tight[8]->Draw("same p");
    gint_N1EVENSUB3[8]->Draw("same p");
    ...
    SetLegend(leg1_1, 24);
    leg1_1->AddEntry(gint_N1EVENSUB3_loose[8],"loose","p");
    leg1_1->AddEntry(gint_N1EVENSUB3_tight[8],"tight","p");
    leg1_1->AddEntry(gint_N1EVENSUB3[8],"nominal","p");
    leg1_1->Draw();
    c2->cd(2);
    TH1D * h2_2 = (TH1D *) h2_1->Clone("h2_2");
    h2_2->Draw();
    gint_N1EVENSUB3_loose[9]->Draw("same p");
    gint_N1EVENSUB3_tight[9]->Draw("same p");
    gint_N1EVENSUB3[9]->Draw("same p");
    ...
    h2_3->Draw();
    gint_N1EVENSUB3_loose[10]->Draw("same p");
    gint_N1EVENSUB3_tight[10]->Draw("same p");
    gint_N1EVENSUB3[10]->Draw("same p");
    ...
    h2_5->Draw();
    diff_gint_N1EVENSUB3_loose[8]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[8]->Draw("same p");
    c2->cd(5);
    gPad->SetGrid(1,1);
    TH1D * h2_6 = (TH1D *) h2_5->Clone("h2_6");
    h2_6->Draw();
    diff_gint_N1EVENSUB3_loose[9]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[9]->Draw("same p");
    c2->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h2_7 = (TH1D *) h2_5->Clone("h2_7");
    h2_7->Draw();
    diff_gint_N1EVENSUB3_loose[10]->Draw("same p");
    diff_gint_N1EVENSUB3_tight[10]->Draw("same p");
    TPad * pad2_8 = (TPad *) c2->cd(7);
    pad2_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);

    c2->Print("../fig_syst_decor_v1even_eta_trackQuality_40_70.pdf","pdf");
