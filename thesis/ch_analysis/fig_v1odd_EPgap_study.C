...
void fig_v1odd_EPgap_study() {
    ...
    TPaveText * txAB1 = new TPaveText(0.74, 0.75, 0.89, 0.87, "NDC");
    SetTPaveTxt(txAB1, 22);
    txAB1->AddText("#eta_{C} = 0");
    txAB1->AddText("20 - 60%");
    txAB1->Draw();

    TLegend * legAB = new TLegend(0.22, 0.21, 0.46, 0.42);
    SetLegend(legAB, 22);
    ...
    cAB->Print("../fig_v1odd_EPgap_study.pdf","pdf");
    // cAB->Print("fig_v1odd_EPgap_study.png","png");
