...
root -l -q -b 'GetVNIntEta.C+("N2SUB3","useTight",-2.4,2.4,0.3,3.0,false)'
root -l -q -b 'GetVNIntEta.C+("N3SUB3","useTight",-2.4,2.4,0.3,3.0,false)'
#
...
root -l -q -b 'GetVNIntEta.C+("N2SUB2","useTight",-2.4,2.4,0.3,3.0,false)'
root -l -q -b 'GetVNIntEta.C+("N3SUB2","useTight",-2.4,2.4,0.3,3.0,false)'
#
...
root -l -q -b 'GetVNIntEta.C+("N2SUB3","useLoose",-2.4,2.4,0.3,3.0,false)'
root -l -q -b 'GetVNIntEta.C+("N3SUB3","useLoose",-2.4,2.4,0.3,3.0,false)'
#
...
root -l -q -b 'GetVNIntEta.C+("N2SUB2","useLoose",-2.4,2.4,0.3,3.0,false)'
root -l -q -b 'GetVNIntEta.C+("N3SUB2","useLoose",-2.4,2.4,0.3,3.0,false)'
#
