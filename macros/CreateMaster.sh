...
root -l -b -q 'GetVN.C+("../MH.root","N1MCm22SUB2",0.4,2.4,true,-1,3,-0.05,0.05,-0.02,0.02)'
root -l -b -q 'GetVN.C+("../MH.root","N1MCp22SUB2",-2.4,-0.4,true,-1,3,-0.05,0.05,-0.02,0.02)'

root -l -b -q 'GetVN.C+("../MH.root","N1MCm22SUB3",0.4,2.4,true,-1,3,-0.05,0.05,-0.02,0.02)'
root -l -b -q 'GetVN.C+("../MH.root","N1MCp22SUB3",-2.4,-0.4,true,-1,3,-0.05,0.05,-0.02,0.02)'
