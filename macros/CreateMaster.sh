...
root -l -b -q 'GetVN.C+("../MH.root","N1HFgSUB2",-1.6,-1.2,false,-1,3,-0.05,0.05,-0.02,0.02)'
root -l -b -q 'GetVN.C+("../MH.root","N1HFgSUB2",1.2,1.6,false,-1,3,-0.05,0.05,-0.02,0.02)'
root -l -b -q 'GetVN.C+("../MH.root","N1HFgSUB3",-1.6,-1.2,false,-1,3,-0.05,0.05,-0.02,0.02)'
root -l -b -q 'GetVN.C+("../MH.root","N1HFgSUB3",1.2,1.6,false,-1,3,-0.05,0.05,-0.02,0.02)'

root -l -b -q 'GetVN.C+("../MH.root","N1EVENSUB2",0.4,2.4,false,-1,3,-0.05,0.05,-0.02,0.02)'
root -l -b -q 'GetVN.C+("../MH.root","N1EVENSUB2",-2.4,-0.4,false,-1,3,-0.05,0.05,-0.02,0.02)'
root -l -b -q 'GetVN.C+("../MH.root","N1EVENSUB3",0.4,2.4,false,-1,3,-0.05,0.05,-0.02,0.02)'
root -l -b -q 'GetVN.C+("../MH.root","N1EVENSUB3",-2.4,-0.4,false,-1,3,-0.05,0.05,-0.02,0.02)'
...
mv vnPlots.root MH_hists_master.root
