...
root -l -b -q 'GetVN.C+("../MH_tight2.root","N1EVENSUB3",1.2,1.6,true,-1,3,-0.05,0.05,-0.02,0.02)'
root -l -b -q 'GetVN.C+("../MH_tight2.root","N1EVENSUB3",-1.6,-1.2,true,-1,3,-0.05,0.05,-0.02,0.02)'
