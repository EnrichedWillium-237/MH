...
// fig 7
//static const int cbinsCENT = 17;
//static const int cminCENT[]={0, 5,10,15,20,25,30,35,40,50,60, 10, 10, 10,20,30,40};
//static const int cmaxCENT[]={5,10,15,20,25,30,35,40,50,60,70, 60, 70, 20,30,40,50};
