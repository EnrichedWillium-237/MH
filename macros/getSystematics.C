...
void getSystematics() {
    ...
    double oddErr[ncbins] = {0.14, 0.14, 0.12, 0.11, 0.10, 0.09, 0.07, 0.06, 0.06, 0.05, 0.05, 0.07};
    double evenErr[ncbins] = {0.08, 0.06, 0.05, 0.05, 0.05, 0.05, 0.06, 0.06, 0.05, 0.06, 0.16, 0.06};
