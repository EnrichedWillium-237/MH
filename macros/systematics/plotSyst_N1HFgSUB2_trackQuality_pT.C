...
TGraphErrors * gA_N1HFgSUB2_tight[ncbins];
TGraphErrors * gA_N1HFgSUB2_loose[ncbins];

TGraphErrors * ratio_gA_N1HFgSUB2_tight[ncbins];
TGraphErrors * ratio_gA_N1HFgSUB2_loose[ncbins];

TGraphErrors * diff_gA_N1HFgSUB2_tight[ncbins];
TGraphErrors * diff_gA_N1HFgSUB2_loose[ncbins];
...
void plotSyst_N1HFgSUB2_trackQuality_pT() {
    ...
    for (int cbin = 0; cbin<ncbins; cbin++) {
        ...
        gA_N1HFgSUB2_tight[cbin] = (TGraphErrors *) fin->Get(Form("tight2/N1HFgSUB2/-2.0_2.0/%d_%d/gA",cmin[cbin],cmax[cbin]));
        gA_N1HFgSUB2_loose[cbin] = (TGraphErrors *) fin->Get(Form("loose/N1HFgSUB2/-2.0_2.0/%d_%d/gA",cmin[cbin],cmax[cbin]));

        ratio_gA_N1HFgSUB2_tight[cbin] = (TGraphErrors *) fin->Get(Form("%s/Ratio_tight2_N1HFgSUB2_-2.0_2.0_%d_%d_gA",tag.data(),cmin[cbin],cmax[cbin]));
        ratio_gA_N1HFgSUB2_loose[cbin] = (TGraphErrors *) fin->Get(Form("%s/Ratio_loose_N1HFgSUB2_-2.0_2.0_%d_%d_gA",tag.data(),cmin[cbin],cmax[cbin]));

        diff_gA_N1HFgSUB2_tight[cbin] = (TGraphErrors *) fin->Get(Form("%s/Difference_tight2_N1HFgSUB2_-2.0_2.0_%d_%d_gA",tag.data(),cmin[cbin],cmax[cbin]));
        diff_gA_N1HFgSUB2_loose[cbin] = (TGraphErrors *) fin->Get(Form("%s/Difference_loose_N1HFgSUB2_-2.0_2.0_%d_%d_gA",tag.data(),cmin[cbin],cmax[cbin]));
        ...
        gA_N1HFgSUB2_loose[cbin]->SetMarkerStyle(20);
        gA_N1HFgSUB2_loose[cbin]->SetMarkerSize(1.0);
        gA_N1HFgSUB2_loose[cbin]->SetMarkerColor(kBlue);
        gA_N1HFgSUB2_loose[cbin]->SetLineColor(kBlue);

        gA_N1HFgSUB2_tight[cbin]->SetMarkerStyle(20);
        gA_N1HFgSUB2_tight[cbin]->SetMarkerSize(1.0);
        gA_N1HFgSUB2_tight[cbin]->SetMarkerColor(kGreen+2);
        gA_N1HFgSUB2_tight[cbin]->SetLineColor(kGreen+2);

        ratio_gA_N1HFgSUB2_tight[cbin]->SetMarkerStyle(20);
        ratio_gA_N1HFgSUB2_tight[cbin]->SetMarkerSize(1.0);
        ratio_gA_N1HFgSUB2_tight[cbin]->SetMarkerColor(kGreen+2);
        ratio_gA_N1HFgSUB2_tight[cbin]->SetLineColor(kGreen+2);

        ratio_gA_N1HFgSUB2_loose[cbin]->SetMarkerStyle(20);
        ratio_gA_N1HFgSUB2_loose[cbin]->SetMarkerSize(1.0);
        ratio_gA_N1HFgSUB2_loose[cbin]->SetMarkerColor(kBlue);
        ratio_gA_N1HFgSUB2_loose[cbin]->SetLineColor(kBlue);

        diff_gA_N1HFgSUB2_tight[cbin]->SetMarkerStyle(20);
        diff_gA_N1HFgSUB2_tight[cbin]->SetMarkerSize(1.0);
        diff_gA_N1HFgSUB2_tight[cbin]->SetMarkerColor(kGreen+2);
        diff_gA_N1HFgSUB2_tight[cbin]->SetLineColor(kGreen+2);

        diff_gA_N1HFgSUB2_loose[cbin]->SetMarkerStyle(20);
        diff_gA_N1HFgSUB2_loose[cbin]->SetMarkerSize(1.0);
        diff_gA_N1HFgSUB2_loose[cbin]->SetMarkerColor(kBlue);
        diff_gA_N1HFgSUB2_loose[cbin]->SetLineColor(kBlue);


        string mtag = Form("N1HFgSUB2_%d_%d",cmin[cbin],cmax[cbin]);


        cN1HFgSUB2_gA_trackQuality[cbin] = new TCanvas(Form("c%s_trackQuality",mtag.data()), Form("c%s_trackQuality",mtag.data()), 600, 900);
        cN1HFgSUB2_gA_trackQuality[cbin]->Divide(1,3,0,0);
        TPad * pad1 = (TPad *) cN1HFgSUB2_gA_trackQuality[cbin]->cd(1);
        ...
        h1->Draw();
        gA_N1HFgSUB2_loose[cbin]->Draw("same p");
        gA_N1HFgSUB2_tight[cbin]->Draw("same p");
        ...
        SetLegend(leg, 24);
        leg->AddEntry(gA_N1HFgSUB2_loose[cbin],"loose","p");
        leg->AddEntry(gA_N1HFgSUB2_tight[cbin],"tight","p");
        leg->AddEntry(gA_N1HFgSUB2[cbin],"nominal","p");
        leg->Draw();

        TPad * pad2 = (TPad *) cN1HFgSUB2_gA_trackQuality[cbin]->cd(2);
        ...
        lnrat->Draw();
        ratio_gA_N1HFgSUB2_loose[cbin]->Draw("same p");
        ratio_gA_N1HFgSUB2_tight[cbin]->Draw("same p");
        TF1 * fit_rat_loose = new TF1("fir_rat_loose", "pol0", -2, 2);
        TGraphErrors * tmp_rat_loose = (TGraphErrors *) ratio_gA_N1HFgSUB2_loose[cbin]->Clone();
        ...
        TGraphErrors * tmp_rat_tight = (TGraphErrors *) ratio_gA_N1HFgSUB2_tight[cbin]->Clone();
        ...
        TPad * pad3 = (TPad *) cN1HFgSUB2_gA_trackQuality[cbin]->cd(3);
        ...
        lndiff->Draw();
        diff_gA_N1HFgSUB2_loose[cbin]->Draw("same p");
        diff_gA_N1HFgSUB2_tight[cbin]->Draw("same p");
        TF1 * fit_diff_loose = new TF1("fir_diff_loose", "pol1", -2, 2);
        TGraphErrors * tmp_diff_loose = (TGraphErrors *) diff_gA_N1HFgSUB2_loose[cbin]->Clone();
        cout<<"\ncrange: "<<cmin[cbin]<<"\t"<<cmax[cbin]<<endl;
        cout<<"loose difference: "<<endl;
        tmp_diff_loose->Fit(fit_diff_loose);
        TF1 * fit_diff_tight = new TF1("fir_diff_tight", "pol1", -2, 2);
        TGraphErrors * tmp_diff_tight = (TGraphErrors *) diff_gA_N1HFgSUB2_tight[cbin]->Clone();
        ...
        cN1HFgSUB2_gA_trackQuality[cbin]->Print(Form("plots/N1HFgSUB2/cN1HFgSUB2_gA_trackQuality_%d_%d.pdf",cmin[cbin],cmax[cbin]),"pdf");
        cN1HFgSUB2_gA_trackQuality[cbin]->Close();
    ...
    h0_1->Draw();
    gA_N1HFgSUB2_tight[0]->Draw("same p");
    gA_N1HFgSUB2_loose[0]->Draw("same p");
    ...
    SetLegend(leg0, 24);
    leg0->AddEntry(gA_N1HFgSUB2_loose[0],"loose","p");
    leg0->AddEntry(gA_N1HFgSUB2_tight[0],"tight","p");
    leg0->AddEntry(gA_N1HFgSUB2[0],"nominal","p");
    leg0->Draw();
    c0->cd(2);
    TH1D * h0_2 = (TH1D *) h0_1->Clone("h0_2");
    h0_2->Draw();
    gA_N1HFgSUB2_tight[1]->Draw("same p");
    gA_N1HFgSUB2_loose[1]->Draw("same p");
    ...
    h0_3->Draw();
    gA_N1HFgSUB2_tight[2]->Draw("same p");
    gA_N1HFgSUB2_loose[2]->Draw("same p");
    ...
    h0_4->Draw();
    gA_N1HFgSUB2_tight[3]->Draw("same p");
    gA_N1HFgSUB2_loose[3]->Draw("same p");
    ...
    h0_5->Draw();
    diff_gA_N1HFgSUB2_tight[0]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[0]->Draw("same p");
    c0->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h0_6 = (TH1D *) h0_5->Clone("h0_6");
    h0_6->Draw();
    diff_gA_N1HFgSUB2_tight[1]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[1]->Draw("same p");
    c0->cd(7);
    gPad->SetGrid(1,1);
    TH1D * h0_7 = (TH1D *) h0_5->Clone("h0_7");
    h0_7->Draw();
    diff_gA_N1HFgSUB2_tight[2]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[2]->Draw("same p");
    TPad * pad0_8 = (TPad *) c0->cd(8);
    pad0_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);
    TH1D * h0_8 = (TH1D *) h0_5->Clone("h0_8");
    h0_8->Draw();
    diff_gA_N1HFgSUB2_tight[3]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[3]->Draw("same p");

    c0->Print("plots/N1HFgSUB2/N1HFgSUB2_trackQuality_pt_0_20.pdf","pdf");
    c0->Print("plots/N1HFgSUB2/N1HFgSUB2_trackQuality_pt_0_20.png","png");
    ...
    h1_1->Draw();
    gA_N1HFgSUB2_tight[4]->Draw("same p");
    gA_N1HFgSUB2_loose[4]->Draw("same p");
    ...
    SetLegend(leg1, 24);
    leg1->AddEntry(gA_N1HFgSUB2_loose[4],"loose","p");
    leg1->AddEntry(gA_N1HFgSUB2_tight[4],"tight","p");
    leg1->AddEntry(gA_N1HFgSUB2[4],"nominal","p");
    leg1->Draw();
    c1->cd(2);
    TH1D * h1_2 = (TH1D *) h1_1->Clone("h1_2");
    h1_2->Draw();
    gA_N1HFgSUB2_tight[5]->Draw("same p");
    gA_N1HFgSUB2_loose[5]->Draw("same p");
    ...
    h1_3->Draw();
    gA_N1HFgSUB2_tight[6]->Draw("same p");
    gA_N1HFgSUB2_loose[6]->Draw("same p");
    ...
    h1_4->Draw();
    gA_N1HFgSUB2_tight[7]->Draw("same p");
    gA_N1HFgSUB2_loose[7]->Draw("same p");
    ...
    h1_5->Draw();
    diff_gA_N1HFgSUB2_tight[4]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[4]->Draw("same p");
    c1->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h1_6 = (TH1D *) h1_5->Clone("h1_6");
    h1_6->Draw();
    diff_gA_N1HFgSUB2_tight[5]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[5]->Draw("same p");
    c1->cd(7);
    gPad->SetGrid(1,1);
    TH1D * h1_7 = (TH1D *) h1_5->Clone("h1_7");
    h1_7->Draw();
    diff_gA_N1HFgSUB2_tight[6]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[6]->Draw("same p");
    TPad * pad1_8 = (TPad *) c1->cd(8);
    pad1_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);
    TH1D * h1_8 = (TH1D *) h1_5->Clone("h1_8");
    h1_8->Draw();
    diff_gA_N1HFgSUB2_tight[7]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[7]->Draw("same p");

    c1->Print("plots/N1HFgSUB2/N1HFgSUB2_trackQuality_pt_20_40.pdf","pdf");
    c1->Print("plots/N1HFgSUB2/N1HFgSUB2_trackQuality_pt_20_40.png","png");
    ...
    h2_1->Draw();
    gA_N1HFgSUB2_tight[8]->Draw("same p");
    gA_N1HFgSUB2_loose[8]->Draw("same p");
    ...
    SetLegend(leg1_1, 24);
    leg1_1->AddEntry(gA_N1HFgSUB2_loose[8],"loose","p");
    leg1_1->AddEntry(gA_N1HFgSUB2_tight[8],"tight","p");
    leg1_1->AddEntry(gA_N1HFgSUB2[8],"nominal","p");
    leg1_1->Draw();
    c2->cd(2);
    TH1D * h2_2 = (TH1D *) h2_1->Clone("h2_2");
    h2_2->Draw();
    gA_N1HFgSUB2_tight[9]->Draw("same p");
    gA_N1HFgSUB2_loose[9]->Draw("same p");
    ...
    h2_3->Draw();
    gA_N1HFgSUB2_tight[10]->Draw("same p");
    gA_N1HFgSUB2_loose[10]->Draw("same p");
    ...
    h2_5->Draw();
    diff_gA_N1HFgSUB2_tight[8]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[8]->Draw("same p");
    c2->cd(5);
    gPad->SetGrid(1,1);
    TH1D * h2_6 = (TH1D *) h2_5->Clone("h2_6");
    h2_6->Draw();
    diff_gA_N1HFgSUB2_tight[9]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[9]->Draw("same p");
    c2->cd(6);
    gPad->SetGrid(1,1);
    TH1D * h2_7 = (TH1D *) h2_5->Clone("h2_7");
    h2_7->Draw();
    diff_gA_N1HFgSUB2_tight[10]->Draw("same p");
    diff_gA_N1HFgSUB2_loose[10]->Draw("same p");
    TPad * pad2_8 = (TPad *) c2->cd(7);
    pad2_8->SetRightMargin(0.02);
    gPad->SetGrid(1,1);

    c2->Print("plots/N1HFgSUB2/N1HFgSUB2_trackQuality_pt_40_70.pdf","pdf");
    c2->Print("plots/N1HFgSUB2/N1HFgSUB2_trackQuality_pt_40_70.png","png");
